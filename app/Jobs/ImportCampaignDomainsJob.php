...
class ImportCampaignDomainsJob implements ShouldQueue
{
    use Queueable, InteractsWithQueue, SerializesModels;

    public const QUEUE = 'import_domains';

    public function __construct(
        public DomainImport $domainImport
    ) {
    ...
    {
        return 'Import Campaign Domains';
    }

    public function handle(): void
    {
        $import = $this->domainImport;
        ...
        try {
            ...
            foreach ($rows as $row) {
                ...
                $normalized = CampaignDomain::normalizeDomain((string) $domain);
                $domainModel = CampaignDomain::updateOrCreate(
                    ...
                    [
                        ...
                        'status' => 'inactive',
                        'domain_import_id' => $import->id,
                    ]
                );
                CampaignDomainHealthCheckJob::dispatch($domainModel);
                $imported++;
            }
